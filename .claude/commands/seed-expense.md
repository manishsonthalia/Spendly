...
Read databse/db.py to understand the expenses tables schema, the db connection pattern, and the database file name.

User input: $ARGUMENTS

## Step 1 - Parse arguements

Extract from $ARGUEMENTS:
- user_id - integer
...
2. Uses these categories with realistic Indian descriptions and amounts (INR):
    - Food: 50-800
    - Transport: 20-500
    - Bills: 200-3000
    - Health: 100-2000
